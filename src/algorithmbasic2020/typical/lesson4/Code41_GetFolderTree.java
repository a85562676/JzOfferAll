...
/**
题目一：
给定一个字符串类型的数组arr,譬如：string[] arr = {"b\st","d\","a\d\e","a\b\c"};
 ...
 */
// 前缀树
public class Code41_GetFolderTree {
    ...
    public static Node generateFolderTree(String[] folderPaths) {
        Node head = new Node(""); //细根目录，前缀树头节点
    ...
    public static void main(String[] args) {
        String[] arrs = new String[]{ "a\\b\\c","a\\b\\s","a\\d\\e","e\\f\\sty"};
        print(arrs);
    }
